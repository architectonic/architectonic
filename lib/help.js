...
export function selfCheck() {
  ...
  assert(resolvePreset("project-system").layers.join(",") === "project,knowledge,skills,meta", "project-system is independent from organization layers");
...
Boundaries:
  ...
  Loops require durable state, verification, a budget, a stop condition, and human-controlled authority.
